        ...
        <div className="relative overflow-hidden rounded-2xl bg-[#0072CE] px-6 py-5 shadow-md">
          ...
          <div className="relative flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex flex-col gap-1">
              <span className="inline-flex w-fit items-center rounded-full bg-[#FFE600] px-4 py-1.5 text-xs font-extrabold uppercase tracking-widest text-[#003580] shadow-sm">
                Pengumuman Divisi
              </span>
              <p className="mt-2 text-sm font-medium text-white/80">
                Kelola pengumuman dan pemberitahuan untuk peserta magang di divisi kamu.
              </p>
            </div>
                    ...
                    <div className="flex flex-col gap-4 p-5 xl:flex-row xl:items-start xl:justify-between">
                      ...
                      <div className="w-full shrink-0 rounded-2xl border border-[#0072CE]/10 bg-[#0072CE]/5 p-4 xl:w-[220px]">
                        ...
                        <div className="mt-4 flex flex-wrap gap-2">
                          <EditPengumumanDialog role="tl" announcement={item} />
                          <DeletePengumumanDialog role="tl" id={item.id} title={item.title} />
                        </div>
                      </div>
                    </div>
                  </div>
