...
export default async function TLPengumumanPage() {
  ...
  return (
    <DashboardLayout navigation={tlNavigation}>
      <div className="space-y-5">
        <DashboardPageHeader
          title="Pengumuman Divisi"
          description="Kelola pengumuman dan pemberitahuan untuk peserta magang di divisi kamu."
        />

        <section className="relative overflow-hidden rounded-[24px] border bg-gradient-to-br from-primary/[0.08] via-background to-background shadow-sm">
          <div className="absolute right-0 top-0 h-40 w-40 rounded-full bg-primary/10 blur-3xl" />

          <div className="relative flex flex-col gap-5 p-5 sm:p-6 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-2xl">
              <div className="inline-flex items-center gap-2 rounded-full border bg-background/80 px-3 py-1 text-[11px] font-medium backdrop-blur">
                <Sparkles className="h-3.5 w-3.5 text-primary" />
                Broadcast Informasi Divisi
              </div>

              <h2 className="mt-4 text-xl font-bold tracking-tight sm:text-2xl">
                Kelola pengumuman dan pemberitahuan
              </h2>

              <p className="mt-2 text-sm leading-7 text-muted-foreground">
                Gunakan pemberitahuan untuk informasi penting seperti jadwal,
                libur, dan perubahan aktivitas peserta.
              </p>
            </div>

            <div className="w-full sm:w-auto">
              <CreatePengumumanDialog role="tl" />
            </div>
          </div>
        </section>
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-base font-semibold sm:text-lg">Info Umum</h3>
          </div>
