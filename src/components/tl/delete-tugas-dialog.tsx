...
import { deleteTugasTL } from "@/actions/tl/delete-tugas";
...
interface DeleteTugasDialogTLProps {
  id: string;
  title: string;
}

export function DeleteTugasDialogTL({ id, title }: DeleteTugasDialogTLProps) {
  ...
  async function handleDelete() {
    ...
    try {
      const result = await deleteTugasTL(id);
